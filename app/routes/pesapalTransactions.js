...
/** route for pesapal-status-notification only */
router.get("/app/tansact_statuses", generatePesaAuthTk, async (req, res, next) => {
    try {
        console.log("here")
        //  console.log("working to make connections", req.body, req.query);
        //console.log("working", req);
        ...
        if (!submitStatusRequest.data) {
            ...
            const { payment_method, amount, payment_status_description, description, payment_account, currency, message, merchant_reference } = submitStatusRequest.data;
            ...
            let paymentStatus = selectMessage(payment_status_description.toLowerCase());
